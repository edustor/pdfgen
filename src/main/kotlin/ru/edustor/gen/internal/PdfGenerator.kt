...
@Component
open class PdfGenerator(val edustorPdfGenApplication: EdustorPdfGenApplication) {
    fun makePdf(outputStream: OutputStream, pageCount: Int) {
        ...
        for (i in 1..pageCount) {
            ...
            canvas.beginText()
                    ...
                    .showText("Generated by Edustor PDFGen Microservice v${edustorPdfGenApplication.version} " +
